...
#N2_structure_DB_old <- read.csv("/Users/choerstm/Documents/MIO_FIGURE/N2_data/Satellite_N2_DB/N2_DB_compiled_Fine_scale_structures.csv")
#N2_structure_DB_old$N2.Rate.nmol.L.1.d.1 <- as.numeric(N2_structure_DB_old$N2.Rate.nmol.L.1.d.1)

N2_eddies_NorthAtlantic <- read.csv("/Users/choerstm/Documents/MIO_FIGURE/N2_data/Satellite_N2_DB/DiazotrophsDatabase-20230616_Shao_markedStations.csv")
...
N2_eddies_NorthAtlantic_mean_annotated <- read.csv("/Users/choerstm/Documents/MIO_FIGURE/N2_data/Satellite_N2_DB/N2_eddies_NorthAtlantic_mean_CORRECTGRID.csv")
