...
## Construct Paths
work_dir <- "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/"
...
#IDENTIFY PRIMER
FWD_PRIMER="TGYGAYCCNAARGCNGA" #nifH1
REV_PRIMER="ADNGCCATCATYTCNCC" #nifH2
...
dim(seqtab.nochim)
write.csv(t(seqtab.nochim), "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/seqtab_all_FIGURE_nifH.csv", quote=FALSE ) # CHANGE ME to output directory.
saveRDS(filterOut, file = "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/seqtab_nochim_FIGURE_nifH.RDA") # CHANGE ME to output directory.
...
write.table(track_reads, "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/tracked_reads_FIGURE_nifH.txt") # CHANGE ME to output directory.


#TAXONOMY
#use Moly's database for dada2

##In case of re-doing the annotation the sequence table can be imported and modified from the import file
seqtab.nochim <- (nifH_ASV)
...
taxa <- assignTaxonomy(seqtab.nochim, "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/Reference_DB/nifH_dada2_phylum_v2.0.5.fasta" , multithread=TRUE, minBoot = 0)
...
head(taxa.print)
#write table
write.table(taxa, "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/ASVs_Taxonomy_FIGURE_nifH20230411_v2_0_5.tsv", sep = "\t", quote=F, col.names=NA)
