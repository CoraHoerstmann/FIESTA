...
nifH_taxonomy_v2 <- read.csv("/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/ASVs_Taxonomy_FIGURE_nifH20230411_v2.tsv", sep = "\t")
...
nifHM_CTD <- left_join(nifHM_CTD, CTD_N2[,c(1,9:14)], by = c('Station', 'Niskin'))
nifHMM_CTD <- nifHM_CTD[,c(1:15,20)]
...
#write.csv(nifH_meta, "nifH_meta_all_metadata_joinedInR.csv")

nifH_meta <- read.csv("/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/nifH_meta_all_metadata_joinedInR.csv")

##CLEAN UP 
rm(nif_meta, nifH_meta2, nifh_meta_f, nif_meta2, nif_meta_f, nif_meta2t)
