...
taxa <- assignTaxonomy(seqtab.nochim, "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/Reference_DB/nifH_dada2_v2.0.3_phylum.fasta" , multithread=TRUE, minBoot = 0)
...
head(taxa.print)
#write table
write.table(taxa, "/Users/corahoerstmann/Documents/MIO_FIGURE/DNA/sequences/nifH_20230410/ASVs_Taxonomy_FIGURE_nifH20230411_v2.tsv", sep = "\t", quote=F, col.names=NA)
